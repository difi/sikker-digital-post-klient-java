...
public class NorskPostadresse2 {

    private NorskPostadresse2(String navn, String adresselinje1, String adresselinje2, String postnummer, String poststed) {
        this.navn = navn;
    ...
    public static class Builder {
        ...
        private final NorskPostadresse2 target;
        private boolean built = false;

        private Builder(String navn, String adresselinje1, String adresselinje2, String postnummer, String poststed) {
            this.target = new NorskPostadresse2(navn, adresselinje1, adresselinje2, postnummer, poststed);
        }

        public NorskPostadresse2 build() {
