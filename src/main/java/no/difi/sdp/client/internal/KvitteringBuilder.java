...
import no.difi.sdp.client.domain.AapningsKvittering;
import no.difi.sdp.client.domain.ForretningsKvittering;
import no.difi.sdp.client.domain.LeveringsKvittering;
import no.difi.sdp.client.domain.TilbaketrekkingsKvittering;
import no.difi.sdp.client.domain.TilbaketrekkingsStatus;
import no.difi.sdp.client.domain.VarslingFeiletKvittering;
import no.difi.sdp.client.domain.Varslingskanal;
