...
public class EbmsForsendelseBuilderTest {
    ...
    public void bygg_minimalt_request() {
        Databehandler databehandler = Databehandler.builder(AktoerOrganisasjonsnummer.of("991825827").forfremTilDatabehandler(), ObjectMother.noekkelpar()).build();
        ...
        EbmsForsendelse ebmsForsendelse = sut.buildEbmsForsendelse(databehandler, Organisasjonsnummer.of("984661185"), forsendelse).getEbmsForsendelse();
